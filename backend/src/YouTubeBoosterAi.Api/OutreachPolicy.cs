...
public static class OutreachPolicy
{
    ...
    public static string NormalizeSkipReason(string? raw)
    {
        ...
        return r switch
        {
            ...
            "not_approved" => "MANUAL_APPROVAL_REQUIRED",
            "manual_approval_required" => "MANUAL_APPROVAL_REQUIRED",
            "approval_expired" => "MANUAL_APPROVAL_REQUIRED",
            "approval_cap" => "MANUAL_APPROVAL_REQUIRED",
            "approval_invalidated" => "MANUAL_APPROVAL_REQUIRED",
            "daily_limit_reached" => "DAILY_LIMIT_REACHED",
            "dry_run" => "DRY_RUN",
            "campaign_disabled" => "CAMPAIGN_DISABLED",
            "no_public_email_found" => "NO_PUBLIC_EMAIL_FOUND",
            "discovery_pending" => "DISCOVERY_PENDING",
            "discovery_backoff" => "DISCOVERY_BACKOFF",
            "needs_human_review" => "NEEDS_HUMAN_REVIEW",
            "duplicate_channel" => "DUPLICATE_CHANNEL",
            "duplicate_email" => "DUPLICATE_EMAIL",
            "ses_quota" or "ses_quota_reached" => "SES_QUOTA_REACHED",
            "safety_paused" or "complaint_pause" => "SAFETY_PAUSED",
            "tick_budget" => "EXECUTION_BUDGET",
            ...
            "weak_personalization" or "insufficient_personalization" => "INSUFFICIENT_PERSONALIZATION",
            "unsupported_private_claim" => "UNSUPPORTED_CLAIM",
            "audit_token_missing" or "audit_not_generated" => "INSUFFICIENT_PERSONALIZATION",
            ...
            "legacy_personal_template" => "NOT_QUALIFIED",
            _ when r.StartsWith("health_stop", StringComparison.Ordinal) => "SAFETY_PAUSED",
