  ...
  return (
    <div className="acq-action-panel">
      ...
      <div className="acq-drawer-primary-actions">
        ...
        {wf.canApprove && onApproveAndSend && (
          <button type="button" className="ops-btn ops-btn-primary" disabled={busy} onClick={onApproveAndSend}>
            Approve &amp; Send
          </button>
        )}
        {wf.canApprove && (
      ...
      <details className="acq-status-change" open={advancedOpen} onToggle={(e) => setAdvancedOpen((e.target as HTMLDetailsElement).open)}>
        <summary className="ops-muted">Advanced</summary>
        {wf.canUnapprove && (
